...
- (void)handlePan:(CGPoint)translate velocity:(CGPoint)velocity isDone:(bool)isDone;
- (void)getTerrainTemplates:(NSMutableArray*)terrains;
- (void)loadTerrainTemplate:(NSString*)terrain;
